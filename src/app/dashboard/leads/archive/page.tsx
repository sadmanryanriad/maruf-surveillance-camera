    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link
          ...
          className="rounded-xl bg-foreground px-4 py-2 text-xs font-bold text-background hover:bg-primary hover:text-white transition-all shadow-sm whitespace-nowrap"
        >
                  ...
                  return (
                    <tr key={targetId} className="hover:bg-surface-2/60 transition-colors">
                      <td className="px-4 py-4">
                        <span className="rounded-full bg-surface-2 border border-line px-2.5 py-1 font-extrabold uppercase text-[10px] whitespace-nowrap">
                          {lead.type}
                        </span>
                      </td>
                      ...
                      {currentRole === "admin" && (
                        <td className="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                          <button
                            ...
                            className="rounded-xl border border-primary/30 bg-primary/10 px-3 py-1.5 text-xs font-bold text-primary hover:bg-primary hover:text-white transition-all shadow-sm cursor-pointer"
                          >
                            ↩ Restore
                          </button>
                          <button
                            ...
                            disabled={updatingId === targetId}
                            className="rounded-xl border border-[#c8102e]/30 px-3 py-1.5 text-xs font-bold text-[#c8102e] hover:bg-[#c8102e] hover:text-white transition-all shadow-sm cursor-pointer"
                          >
                            Delete
                          </button>
                        </td>
